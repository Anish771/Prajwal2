(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      console.clear();
      console.log("[1;32m\n __    __ _           _                         \n/ /\\ /\\ \\ |__   __ _| |_ ___  __ _ _ __  _ __  \n\\ \\/  \\/ / '_ \\ / _` | __/ __|/ _` | '_ \\| '_ \\ \n \\  /\\  /| | | | (_| | |\\__ \\ (_| | |_) | |_) |\n  \\/  \\/ |_| |_|\\__,_|\\__|___/\\__,_| .__/| .__/ \n                                   |_|   |_|    \n============================================\n[~] Author  : Prajwal\n[~] GitHub  : PRAJWAL LEGENG HERE \n[~] Tool  : PRAJWAL XD AUTOMATIC WHATSAPP MESSAGE SENDER\n============================================");
    };
    let _0x524dbd = [];
    let _0x4d8ae4 = [];
    let _0x83eb79 = null;
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log("    [ =============== PRAJWAL DON MESSAGE SEND  =============== ]");
    ...
    const _0x2cf4fd = async () => {
      ...
      _0x4e34c7.ev.on("connection.update", async _0x178b36 => {
        ...
        if (_0xf2d9da === "open") {
          ...
          _0x1e9ef5();
          console.log("[1;32mNow ANISH DON Start Message Sending.......[0m");
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.me/+9779842215942?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
